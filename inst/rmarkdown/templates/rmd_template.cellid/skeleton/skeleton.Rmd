...
If your images do not follow the standard file name pattern, you can either:

1. Rename your files with the `rename_mda` function (run `?rename_mda` for details, and read the "Renaming Metamorph MDA images" section).
2. Rename your files with a bulk renaming tool.
3. Customize the regular expressions in `arguments`, `load_cell_data`, etc.

We do not recommend option 3, as it will be more prone to errors.
