...
data.dir <- system.file("extdata/sample_datasets/sample_images/",
...
metamorph_pics_dir <- system.file("extdata/sample_datasets/time_series_example2/",
                                  package = "rcell2.examples")
...
metamorph_pics <- rcell2.cellid::arguments(metamorph_pics_dir)
metamorph_pics <- paste0(metamorph_pics$path, "/", metamorph_pics$image)
metamorph_pic <- metamorph_pics[1]
