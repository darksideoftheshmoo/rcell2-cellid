...
- **Read the README**.md at rcell2's GitHub repo and the help page of each function using R's `?`.
- **Preview images** with FIJI-ImageJ before you begin. No analysis package exists (yet) that can replace a researcher's visual assesment.
