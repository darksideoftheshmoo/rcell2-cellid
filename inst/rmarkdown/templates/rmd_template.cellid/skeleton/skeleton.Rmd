...
```{r}
result <- plot_pos_overlaps(image_list)
...
# Iterate (this can take a while...)
doParallel::registerDoParallel(cl)

foreach(fft.bfs.subdir=fft.bfs.subdirs, 
        .packages="rcell2.cellid") %dopar% {
...
You can run Cell-ID using the following directory as the new `data.dir`:
