...
```{r include=F}
# saveRDS(cell2.out, file = "inst/extdata/cell2.out.RDS")
cell2.out <- readRDS(file = "inst/extdata/cell2.out.RDS")
```
...
```{r include=F}
# saveRDS(cell2.result, file = "inst/extdata/cell2.result.RDS")
cell2.result <- readRDS(file = "inst/extdata/cell2.result.RDS")
```
