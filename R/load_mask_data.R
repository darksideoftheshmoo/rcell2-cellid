...
#'
#' @param positions A "positions" dataframe (i.e. a data.frame/list with one "output" column/item, containing paths pointing to the output directories generated by Cell-ID). Alternatively, the "arguments" dataframe, as produced by \code{rcell2.cellid::arguments} for the experiment. Required only for \code{data.source = "masks.tsv"}.
...
#' 
#' @param data If \code{data.source = "masks.tsv"}, a "positions" data frame (i.e. a data.frame/list with one "output" column/item, containing paths pointing to the output directories generated by Cell-ID) or, equivalently, the "arguments" dataframe, as produced by \code{rcell2.cellid::arguments}. If \code{data.source = "out.tif"}, a cell.data object (prepared with \code{rcell2.cellid::get_cell_data}).
